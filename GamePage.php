...
<?php include("includes/nav.php");
    ?>
    <h1>WELCOME PLAY EVERYONE <span style="color:#30593D">Ark: Survival Evolved!</span></h1>
...
<h4 style="font-size: 24px; color: white; text-transform: uppercase; margin-bottom: 0;">GAMEPLAY<h4>
    <br>
<p>Ark: Survival Evolved is an action-adventure survival game.</br> Set in an open world environment with a dynamic day-night cycle and </br>played either from a third-person or first-person perspective. To survive, players must</br> establish a base, with a fire and weapons;additional activities, such as taming and feeding </br>dinosaurs, require more resources. The game's world, known as the "Ark", is approximately</br> 48 km2 (19 sq mi) in size: there is approximately 36 km2 (14 sq mi) of land with 12 km2 (4.6 sq mi) of ocean.</br>
There are currently 176 creatures that populate the world of Ark. In the early versions of the game, nearly all</br> creatures were real dinosaurs and other prehistoric creatures, however, as the storyline progressed.
    
<div class="grid">
<table >
<tr>
    <td><img src="layouts/img/3.png" height="200px" width="200px"/></td>
    <td><img src="layouts/img/4.jpg" height="200px" width="200px"/></td>
</tr>
<tr>
    <td><img src="layouts/img/5.jpg" height="200px" width="200px"/></td>
