<?php
    ...
    if(isset($_POST['add']))
    {
       ...
       // $game_id = mysqli_fetch_assoc($res);
        ...
        $sql  = "INSERT INTO `news` (`name`, `descripton`, `link`,`img`) VALUES ( '$name', '$description', '$link','$filename')";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="add-news.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">  
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user "
                                                name="link" aria-describedby="emailHelp"
