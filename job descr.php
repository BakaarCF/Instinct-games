...
<body id="be" style=" background-color: white; color:black; ">
    ...
    <button class="zorar" style="background-color:#30593D; color: white;"><span>Apply now </span></button>
        ...
        <div class="qualifications" style=" margin-left: 10%; margin-top: 40px;max-width: 55%;">
            ...
            <br>
            <p>You will need work experience and a portfolio of work to show employers. This can be obtained through internships and holiday work. Employers also expect a good knowledge of design software, such as Quark Xpress, InDesign or Illustrator, plus photo-editing software such as PhotoShop.</p>
            <br>
        ...
        <div class="skills" style=" margin-left: 10%; margin-top: 40px;max-width: 55%;">
            ...
            <li style="color:black; margin-left: 45px;">Exceptional creativity and innovation</li>
            <li style="color:black; margin-left: 45px;">Excellent time management and organisational skills</li>
            <li style="color:black; margin-left:45px;">Accuracy and attention to detail</li>
            <li style="color:black; margin-left: 45px;">An understanding of the latest trends and their role within a commercial environment</li>
            <li style="color:black; margin-left: 45px;">Professional approach to time, costs and deadlines</li>  
            </ul>
