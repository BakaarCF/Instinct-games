...
<div class="containerrrr">
    ...
    <h5>Choose an option to autocomplete your application. You can still fill your profile manually.</h5>
      ...
      <img style="width:180px;height:180px; margin-left:20px; margin-bottom:10px; border-radius:90%;" src="layouts/img/Users/<?php echo $user['image']; ?>">
            ...
            <form  style=" margin-left: 210px; margin-top: -170px;">
...
<div class="experience">
        <h1 style="font-weight: bold; margin-left: 380px; margin-top:35px;">Experience</h1>
        <button type="button" class="exbutton" onclick="openForm2()" style="font-weight: bold;margin-left:978px;">+  Add</button>
      </div>
      ...
      <hr size="1" width="75%" color="#d4d4d4" style="margin-left:300px;">  
      <div class="experience">
        <h1 style="font-weight: bold; margin-left: 380px; margin-top:35px;">Education</h1>
        <button type="button" class="exbutton" onclick="openForm()" style="font-weight: bold;margin-left:995px;">+  Add</button>
      </div>
...
<h2 style="font-weight: bold; margin-left: 370px; margin-bottom:0px20px;">Message to Hiring Manager</h2> 
<h5 style="margin-left: 370px; margin-top:8px;">Let the company know about your interest working there.</h5>
    <textarea name="message" class="text-box" rows="12" style="margin-left: 370px;"></textarea>
</div>
